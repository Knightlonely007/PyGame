...
class Level:
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int]):
        ...
        # Ajustando o tempo limite para o Level 3
        if self.name == 'Level3':
            self.timeout = 40000
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == EVENT_ENEMY:
                    # Lógica para garantir que somente o Enemy3 spawne no Level 3
                    if self.name == 'Level3':
                        # No Level 3, sempre cria o Enemy3
                        self.entity_list.append(EntityFactory.get_entity('Enemy3'))
                    else:
                        # Para outros níveis, escolhe aleatoriamente entre Enemy1 ou Enemy2
